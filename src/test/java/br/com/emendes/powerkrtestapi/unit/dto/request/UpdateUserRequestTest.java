...
@DisplayName("Unit tests for UpdateUserRequest")
class UpdateUserRequestTest {
  ...
  class NameValidation {
    ...
    void validateName_MustNotReturnViolations_WhenNameIsValid(String validName) {
      ...
      Set<ConstraintViolation<UpdateUserRequest>> actualViolations = validator
          .validateProperty(updateUserRequest, "name");
  ...
  class EmailValidation {
    ...
    void validateEmail_MustNotReturnViolations_WhenEmailIsValid() {
      ...
      Set<ConstraintViolation<UpdateUserRequest>> actualViolations = validator
          .validateProperty(updateUserRequest, "email");
    ...
    void validateEmail_MustReturnViolations_WhenEmailContainsMoreThan255Characters() {
      ...
      Assertions.assertThat(actualViolations).isNotEmpty();
      Assertions.assertThat(actualMessages).contains("email must max 255 characters");
    }
